...
export const questions: Question[] = [
  // ========== LEVEL A (13yo - Advanced Junior Cycle / Pre-Senior Cycle) ==========
  ...
  // COMPUTER/LOGIC (Bebras-style) - Level A
  {
    id: "logic-A-1",
    subject: "logic",
    level: "A",
  ...
  // ========== LEVEL B (10yo - Irish Primary 4th/5th Class) ==========
  ...
  // These questions were provided by the user for Pink and Rosie

  // PINK's QUESTIONS (Level A)

  // Math - IMTA Olympiad Style
  {
    id: "p_math_001",
    subject: "math",
    level: "A",
  ...
  // Logic - Scratch to Python Bridge
  {
    id: "r_logic_001",
    subject: "logic",
    level: "B",
  ...
  // Math - Game Design HP percentages
  {
    id: "r_math_001",
    subject: "math",
    level: "B",
